...
export default {
    ...
    setup(props) {
        ...
        const renderTdList = (row, rowIndex) => columns.value.map((column, columnIndex) => {
        ...
        const renderTrList = () => showData.value.map((row, rowIndex) => (
        ...
        return () => (
            ...
            >
                ...
                {isUndefined(props.height) && <TableHeaderContent fixedColumn={props.fixedColumn} />}
