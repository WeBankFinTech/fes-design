<template>
    <f-layout style="min-height: 100vh">
        <f-aside v-model:collapsed="collapsed" collapsible inverted fixed>
            <f-menu mode="vertical" inverted :collapsed="collapsed">
                <f-sub-menu value="1">
                    <template #icon>
                        <AppstoreOutlined />
                    </template>
        ...
        <f-layout>
            ...
            <FMain class="demo-main-wrapper">
                <div class="demo-main-page">Main</div>
            </FMain>
            <FFooter class="demo-tal">
