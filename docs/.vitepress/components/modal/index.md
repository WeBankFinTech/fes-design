...
### 内容的最大高度
`maxContentHeight`默认不设置，如果实际内容的`height`高于`maxContentHeight`，以`maxContentHeight`为准，内容滚动。


:::demo
maxContentHeight.vue
:::
...
| maxContentHeight | 最大内容高度，如果实际内容的高度大于maxContentHeight，内容滚动                 | String/Number     | `-`                   |
